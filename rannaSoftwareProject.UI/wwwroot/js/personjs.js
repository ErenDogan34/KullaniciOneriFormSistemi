...
function loadTableData() {
    $.ajax({
        url: 'https://localhost:44375/api/User/GetUser',
        method: 'GET',
...
function deleteUser(id) {
    if (confirm("Bu kullanıcıyı silmek istediğinize emin misiniz?")) {
        $.ajax({
            url: 'https://localhost:44375/api/User/DeleteUser' + '?id=' + id,
            method: 'DELETE',
            beforeSend: function (xhr) {
                xhr.setRequestHeader('Authorization', 'Bearer ' + token);
            },
...
$(document).on('click', '.updateUserDisplay', function () {
    ...
    console.log("aa")
    $.ajax({
        url: 'https://localhost:44375/api/User/GetByIdPerson/?id=' + id,
        method: 'GET',
        beforeSend: function (xhr) {
            xhr.setRequestHeader('Authorization', 'Bearer ' + token);
        },
...
$(document).on('click', '#saveUpdateButton', function () {
    ...
    $.ajax({
        url: 'https://localhost:44375/api/User/UpdatePerson',
        method: 'POST',
        beforeSend: function (xhr) {
            xhr.setRequestHeader('Authorization', 'Bearer ' + token);
        },
...
$('#saveUserButton').click(function () {
    ...
    $.ajax({
        url: 'https://localhost:44375/api/User/AddUser',
        method: 'POST',
        contentType: 'application/json',

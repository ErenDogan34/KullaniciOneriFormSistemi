...
if (isTokenValid) {
    ...
    if (role === "Admin") {
        ...
        form.innerHTML = `<a class="nav-link text-dark" href="/Form/GetAllForm">Formlar</a>`;
        navLinks.appendChild(form);
    } else {
        var userLink = document.createElement("li");
        userLink.className = "nav-item";
        userLink.innerHTML = `<a class="nav-link text-dark" href="/Form/Index">Form Ekleme</a>`;
...
$(document).on("click", '#logoutLink', function (e) {
    ...
    window.location.href = '/home'; // Veya istediğiniz başka bir sayfa
});
